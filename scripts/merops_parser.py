...
parser = argparse.ArgumentParser(description="""Parse merops file""")
...
with open(in_file, "r") as f:
    ...
    for line in lines:
        ...
        if line.startswith(
            ...
            if (
                query in protein2bit_dict
            ):  # If query is in prtein2bit_dict, it means we have seen this protein before, so now we want to see what bit score it had to the previous hit.
